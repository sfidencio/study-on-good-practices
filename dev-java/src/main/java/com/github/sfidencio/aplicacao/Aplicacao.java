...
import com.github.sfidencio.dominio.servico.ClienteServico;
...
public class Aplicacao {
    public static Logger logger = Logger.getLogger(Aplicacao.class.getName());
    ...
    public static void main(String[] args) {
         ...
         */
        try {
            servico.validarQuantidade(todasTransacoesRealizadas, new BigDecimal("100.0"));
